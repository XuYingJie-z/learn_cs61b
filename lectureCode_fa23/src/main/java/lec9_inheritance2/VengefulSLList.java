...
public class VengefulSLList<Item> extends SLList<Item> {
    ...
    public static void main(String[] args) {
		...
		VengefulSLList<Integer> vs1 = new VengefulSLList<Integer>(20);
        ...
        // static type 和 dynamic type
        VengefulSLList<Integer> vs2 = new VengefulSLList<Integer>(20);
        SLList<Integer> sl = vs2;  
        // VengefulSLList<Integer> vs3 = sl; // 父类不能赋值给子类
        sl.addLast(50);
        sl.addLast(30);
        sl.removeLast();	
        sl.print();
